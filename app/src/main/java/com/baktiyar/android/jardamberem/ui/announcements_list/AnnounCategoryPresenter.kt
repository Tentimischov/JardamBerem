...
class AnnounCategoryPresenter(var v: AnnounCategoryContract.View, var context: Context) : AnnounCategoryContract.Presenter {
    override fun getDataFirst(limit: Int, offset: Int) {
        ...
        ApplicationClass.INSTANCE?.service?.getAnnounByCategory(Settings.getCategoryId(context), limit, offset, Settings.getSpinnerItemPosition(context) != 0)?.enqueue(object : Callback<AnnouncementsPaginated> {
