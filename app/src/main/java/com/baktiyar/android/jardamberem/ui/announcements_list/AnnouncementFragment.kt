...
class AnnouncementFragment : Fragment(), AnnounCategoryContract.View, MainAnnouncementAdapter.OnItemClickListener {
    ...
    companion object {
        ...
        fun newInstance(isNeeded: Boolean): AnnouncementFragment {
